...
set( MSVC_C_AND_CXX_COMPILE_OPTIONS
	# Set warning level
	/W4
...
list( APPEND ADDITIONAL_COMPILE_OPTIONS_EXE
	$<$<CONFIG:Debug>:/ZI>
	$<$<CONFIG:Release>:/Zi>
	"${MSVC_C_AND_CXX_COMPILE_OPTIONS}"
)

list( APPEND ADDITIONAL_COMPILE_OPTIONS_DLL
	$<$<CONFIG:Debug>:/ZI>
	$<$<CONFIG:Release>:/Zi>
	"${MSVC_C_AND_CXX_COMPILE_OPTIONS}"
)

list( APPEND ADDITIONAL_COMPILE_OPTIONS_LIB
	$<$<CONFIG:Debug>:/ZI>
	$<$<CONFIG:Release>:/Z7>
	"${MSVC_C_AND_CXX_COMPILE_OPTIONS}"
)
...
list( APPEND ADDITIONAL_COMPILE_DEFINITIONS_EXE
	$<$<CONFIG:Debug>:_HAS_ITERATOR_DEBUGGING=0>
)

list( APPEND ADDITIONAL_COMPILE_DEFINITIONS_DLL
	_USRDLL
	$<$<CONFIG:Debug>:_HAS_ITERATOR_DEBUGGING=0>
)

list( APPEND ADDITIONAL_COMPILE_DEFINITIONS_LIB
	_LIB
	$<$<CONFIG:Debug>:_HAS_ITERATOR_DEBUGGING=0>
)
