...
function(link_to_bin)
	...
	add_custom_command(
		TARGET ${CTB_TARGET}
		POST_BUILD
			COMMAND ${CMAKE_COMMAND} -E create_symlink $<TARGET_FILE:${CTB_TARGET}> ${GAMEDIR}/bin/$<TARGET_FILE_NAME:${CTB_TARGET}>
	)
endfunction()
...
function(declare_library)
	...
	set( "ASRC_${DL_TARGET}" $<TARGET_FILE:${DL_TARGET}> PARENT_SCOPE )
endfunction()