...
public:
	CLCDItemText() : m_bHasWildcard( false ),
					 m_iSize( 0 ),
					 m_iAlign( 0 ) {
		m_Type = LCDITEM_TEXT;
	}
...
public:
	CLCDItemAggregate() : m_AggType( AGGTYPE_UNKNOWN ),
