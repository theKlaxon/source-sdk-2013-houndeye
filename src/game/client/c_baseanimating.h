...
public:
	...
	LocalFlexController_t GetNumFlexControllers();
	...
	virtual void UpdateBoneAttachments();
	...
	virtual void RefreshCollisionBounds();
	...
	virtual void ResetClientsideFrame() { SetCycle( 0 ); }
	...
	virtual float GetServerIntendedCycle() { return -1.0f; }
	...
	void SetReceivedSequence();
	virtual bool ShouldResetSequenceOnNewModel();
...
protected:
	...
	virtual int GetStudioBody() { return m_nBody; }
...
public:
	...
	void ClientThink();
	void ReleaseRagdoll() { m_bReleaseRagdoll = true; }
	bool ShouldSavePhysics() { return true; }
	virtual void OnSave();
	virtual void OnRestore();
	virtual int ObjectCaps() { return BaseClass::ObjectCaps() | FCAP_SAVE_NON_NETWORKABLE; }
	virtual IPVSNotify* GetPVSNotifyInterface() { return this; }

	void HandleAnimatedFriction();
...
inline bool C_BaseAnimating::IsSequenceFinished() {
	return m_bSequenceFinished;
}

inline float C_BaseAnimating::SequenceDuration() {
