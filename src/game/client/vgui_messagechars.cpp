...
// Output :
//-----------------------------------------------------------------------------
CMessageCharsPanel::CMessageCharsPanel( vgui::VPANEL parent ) : BaseClass( nullptr, "CMessageCharsPanel" ) {
	SetParent( parent );
...
// Output :
//-----------------------------------------------------------------------------
CMessageCharsPanel::~CMessageCharsPanel() {
}
...
//-----------------------------------------------------------------------------
CMessageCharsPanel::message_t* CMessageCharsPanel::AllocMessage() {
	...
	msg->hCustomFont = NULL_PANEL_HANDLE;
...
// Purpose:
//-----------------------------------------------------------------------------
void CMessageCharsPanel::OnTick() {
...
//-----------------------------------------------------------------------------
bool CMessageCharsPanel::ShouldDraw() {
	if ( !m_pActive ) {
		return false;
	}
