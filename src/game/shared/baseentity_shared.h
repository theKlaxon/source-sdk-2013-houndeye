...
enum InvalidatePhysicsBits_t {
	...
	// CBaseEntity inlines
	inline bool CBaseEntity::IsPlayerSimulated() const {
		return m_bIsPlayerSimulated;
	}

	inline CBasePlayer* CBaseEntity::GetSimulatingPlayer() {
...
inline int CBaseEntity::GetFlags() const {
	return m_fFlags;
}
...
inline CBasePlayer* CBaseEntity::GetPredictionPlayer() {
...
inline int CBaseEntity::GetEffects() const {
	return m_fEffects;
}
