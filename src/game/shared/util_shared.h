...
inline void UTIL_TraceRay( const Ray_t& ray, unsigned int mask,
						   const IHandleEntity* ignore, int collisionGroup, trace_t* ptr, ShouldHitFunc_t pExtraShouldHitCheckFn = nullptr ) {
...
#define DECLARE_AUTO_LIST( interfaceName )                                                                                       \
	...
	public:                                                                                                                      \
		...
		static const CUtlVector<interfaceName*>& AutoList() { return m_##interfaceName##AutoList; }                        \
                                                                                                                                 \
	private:                                                                                                                     \
...
private:
	float m_timestamp;
	float Now() const;// work-around since client header doesn't like inlined gpGlobals->curtime
};
...
private:
	float m_duration;
	float m_timestamp;
	virtual float Now() const;// work-around since client header doesn't like inlined gpGlobals->curtime
};
