...
public:
	...
	void AddControlPoint( CNewParticleEffect* pEffect, int iPoint, C_BaseEntity* pEntity, ParticleAttachment_t iAttachType, const char* pszAttachmentName = nullptr, Vector vecOriginOffset = vec3_origin );
	...
	// Commands
	void StopEmission( CNewParticleEffect* pEffect = nullptr, bool bWakeOnStop = false, bool bDestroyAsleepSystems = false );
