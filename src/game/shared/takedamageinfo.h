...
public:
	...
	CTakeDamageInfo( CBaseEntity* pInflictor, CBaseEntity* pAttacker, const Vector& damageForce, const Vector& damagePosition, float flDamage, int bitsDamageType, int iKillType = 0, Vector* reportedPosition = nullptr );
	CTakeDamageInfo( CBaseEntity* pInflictor, CBaseEntity* pAttacker, CBaseEntity* pWeapon, const Vector& damageForce, const Vector& damagePosition, float flDamage, int bitsDamageType, int iKillType = 0, Vector* reportedPosition = nullptr );
	...
	void SetDamageBonus( float flBonus, CBaseEntity* pProvider = nullptr );
	...
	bool IsForceFriendlyFire() const { return m_bForceFriendlyFire; }
	...
	void Set( CBaseEntity* pInflictor, CBaseEntity* pAttacker, const Vector& damageForce, const Vector& damagePosition, float flDamage, int bitsDamageType, int iKillType = 0, Vector* reportedPosition = nullptr );
	void Set( CBaseEntity* pInflictor, CBaseEntity* pAttacker, CBaseEntity* pWeapon, const Vector& damageForce, const Vector& damagePosition, float flDamage, int bitsDamageType, int iKillType = 0, Vector* reportedPosition = nullptr );
...
public:
	...
	bool IsClear() { return ( m_hTarget == nullptr ); }
...
inline void CTakeDamageInfo::SetDamageBonus( float flBonus, CBaseEntity* pProvider /*= nullptr*/ ) {
