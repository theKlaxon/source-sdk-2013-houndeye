...
public:
	...
	virtual CBaseEntity* GetOwner() { return m_hOwner; };
	...
	virtual CBaseEntity* GetOwnerViaInterface() { return GetOwner(); }
	...
	// Only support prediction in TF2 for now
		...
		#ifdef CLIENT_DLL
			virtual bool ShouldResetSequenceOnNewModel() { return false; }
