...
public:
	...
	const Vector& CollisionSpaceMins() const;

	// Get the collision space maxs directly
	const Vector& CollisionSpaceMaxs() const;
...
inline void CCollisionProperty::ClearSolidFlags() {
	SetSolidFlags( 0 );
}
...
inline int CCollisionProperty::GetSolidFlags() const {
...
// Get the collision space mins directly
inline const Vector& CCollisionProperty::CollisionSpaceMins() const {
	return m_vecMins;
}

// Get the collision space maxs directly
inline const Vector& CCollisionProperty::CollisionSpaceMaxs() const {
	return m_vecMaxs;
}
