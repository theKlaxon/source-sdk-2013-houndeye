...
public:
	...
	Ep2LevelStats_t() : m_bInitialized( false ),
...
public:
	...
	struct EntityDeathsLump_t {
		...
		EntityDeathsLump_t() : m_nBodyCount( 0u ),
							   m_nKilledPlayer( 0u ) {
		}
	...
	struct SaveGameInfoRecord_t {
		SaveGameInfoRecord_t() : m_nFirstDeathIndex( -1 ),
								 m_nNumDeaths( 0 ),
								 m_nSaveHealth( -1 ) {
...
#pragma pack( 1 )
	...
	struct SaveGameInfoRecord2_t : public SaveGameInfoRecord_t {
		...
		SaveGameInfoRecord2_t() : m_SaveType( (byte) TYPE_UNKNOWN ) {
		}
...
#pragma pack()
	...
	struct SaveGameInfo_t {
		...
		SaveGameInfo_t() : m_nCurrentSaveFileTime( 0 ),
	...
	struct GenericStatsLump_t {
		...
		GenericStatsLump_t() : m_unCount( 0u ),
