...
public:
	...
	CBaseEntity* GetTarget() { return m_hTargetEnt; };
	...
	bool PlayedSequence() { return m_sequenceStarted; }
	bool CanEnqueueAfter();

	// Entry & Action loops
	bool IsPlayingEntry() { return m_bIsPlayingEntry; }
	bool IsPlayingAction() { return ( m_sequenceStarted && !m_bIsPlayingEntry ); }
	bool FinishedActionSequence( CAI_BaseNPC* pNPC );
	void SetLoopActionSequence( bool bLoop ) { m_bLoopActionSequence = bLoop; }
	bool ShouldLoopActionSequence() { return m_bLoopActionSequence; }
	...
	bool IsTeleportingDueToMoveTo() { return m_bIsTeleportingDueToMoveTo; }
