...
public:
	...
	void UpdateOwningTeam();
	void UpdateCappingTeam( int iTeam );
	void UpdateTeamInZone();
	void UpdateBlocked();
	...
	CHandle<CTeamControlPoint> GetControlPoint() { return m_hPoint; }

	int GetOwningTeam() { return m_nOwningTeam; }
	...
	CTeamTrainWatcher* GetTrainWatcher() const { return m_hTrainWatcher; }
...
private:
	...
	void IncrementCapAttemptNumber();
