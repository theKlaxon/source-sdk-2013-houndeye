...
public:
	...
	virtual void Precache();// derived calls at start of Spawn()
	virtual bool CreateVPhysics();
	virtual void NPCInit();// derived calls after Spawn()
	void NPCInitThink();
...
public:
	...
	virtual void PostscheduleThink() { return; };
	...
	virtual void OnStartScene() {}// Called when an NPC begins a cine scene (useful for clean-up)
	virtual bool ShouldPlayerAvoid();
	virtual void SetPlayerAvoidState();
	virtual void PlayerPenetratingVPhysics();
...
public:
	...
	inline int TaskIsComplete() { return ( GetTaskStatus() == TASKSTATUS_COMPLETE ); }
...
protected:
	...
	int SelectFlinchSchedule();

	virtual bool IsAllowedToDodge();
...
private:
	...
	void OnStartTask() { SetTaskStatus( TASKSTATUS_RUN_MOVE_AND_TASK ); }
...
public:
	...
	virtual CAI_BehaviorBase* GetRunningBehavior() { return nullptr; }
...
public:
	...
	Activity GetScriptCustomMoveActivity();
	int GetScriptCustomMoveSequence();
...
public:
	...
	float GetAcceptableTimeSeenEnemy() { return m_flAcceptableTimeSeenEnemy; }
	...
	virtual bool ShouldPickADeathPose() { return true; }

	virtual bool AllowedToIgnite() { return false; }
...
public:
	...
	virtual bool CanBeUsedAsAFriend();
...
public:
	...
	//-----------------------------------------------------
public:
	float GetInteractionYaw() const { return m_flInteractionYaw; }
...
protected:
	...
	bool IsRunningDynamicInteraction() { return ( m_iInteractionState != NPCINT_NOT_RUNNING && ( m_hCine != nullptr ) ); }
	bool IsActiveDynamicInteraction() { return ( m_iInteractionState == NPCINT_RUNNING_ACTIVE && ( m_hCine != nullptr ) ); }
	ScriptedNPCInteraction_t* GetRunningDynamicInteraction() { return &( m_ScriptedInteractions[ m_iInteractionPlaying ] ); }
	void SetInteractionCantDie( bool bCantDie ) { m_bCannotDieDuringInteraction = bCantDie; }
	bool HasInteractionCantDie();
...
public:
	...
	virtual void FearSound() { return; };
	virtual void LostEnemySound() { return; };
	virtual void FoundEnemySound() { return; };
...
public:
	...
	//
	//-----------------------------------------------------
	virtual int CapabilitiesGet() const;
...
public:
	...
	virtual float MaxYawSpeed();// Get max yaw speed
	bool FacingIdeal();
...
public:
	...
	const Vector& GetDefaultEyeOffset() { return m_vDefaultEyeOffset; }
	...
	virtual CBaseEntity* EyeLookTarget();// Overridden by subclass to force look at an entity
	...
	virtual Vector FacingPosition() { return EyePosition(); };// position that other npc's use when facing you

	virtual void MaintainTurnActivity();
...
public:
	...
	//-----------------------------------------------------
	inline bool IsInAScript() { return m_bInAScript; }
...
public:
	...
	bool TaskRanAutomovement() { return m_ScheduleState.bTaskRanAutomovement; }
	...
	bool IsInLockedScene() { return m_flSceneTime > gpGlobals->curtime; };
	float m_flSceneTime;
...
public:
	...
	virtual int HolsterWeapon();
	virtual int UnholsterWeapon();
...
public:
	...
	string_t GetHintGroup() { return m_strHintGroup; }
	void ClearHintGroup() { SetHintGroup( NULL_STRING ); }
	void SetHintGroup( string_t name, bool bHintGroupNavLimiting = false );
	bool IsLimitingHintGroups() { return m_bHintGroupNavLimiting; }
	...
	virtual float CoverRadius() { return 1024; }// Default cover radius
	virtual float GetMaxTacticalLateralMovement() { return MAXTACLAT_IGNORE; }
...
public:
	...
	void NPCInitDead();// Call after animation/pose is set up
	...
	virtual float InnateRange1MinRange() { return 0.0f; }
	virtual float InnateRange1MaxRange() { return FLT_MAX; }
	...
	virtual bool IsWaitingToRappel() { return false; }
...
protected:
	...
	virtual float GetReasonableFacingDist();
...
public:
	...
	// Crouch handling
	//-----------------------------------------------------
	bool CrouchIsDesired() const;
	virtual bool IsCrouching();
	inline void ForceCrouch();
	inline void ClearForceCrouch();

protected:
	virtual bool Crouch();
	virtual bool Stand();
	virtual void DesireCrouch();
	inline void DesireStand();
...
protected:
	...
	virtual Vector GetCrouchEyeOffset() { return Vector( 0, 0, 40 ); }
	virtual Vector GetCrouchGunOffset() { return Vector( 0, 0, 36 ); }
...
public:
	...
	bool IsNavigationDeferred() { return m_bDeferredNavigation; }
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
inline bool CAI_BaseNPC::CrouchIsDesired() const {
...
// Purpose:
//-----------------------------------------------------------------------------
inline void CAI_BaseNPC::DesireStand() {
...
// Purpose:
//-----------------------------------------------------------------------------
inline void CAI_BaseNPC::ForceCrouch() {
	m_bForceCrouch = true;
	Crouch();
}
...
// Purpose:
//-----------------------------------------------------------------------------
inline void CAI_BaseNPC::ClearForceCrouch() {
...
#define AI_BEGIN_CUSTOM_SCHEDULE_PROVIDER( derivedClass ) \
	...
	void derivedClass::InitCustomSchedules() {            \
...
inline const QAngle& CAI_Component::GetLocalAngles() const {
...
public:
	...
	virtual void AlyxStartedInteraction() = 0;
	virtual void AlyxFinishedInteraction() = 0;
};
...
public:
	...
	// Alyx specific interactions
	virtual void AlyxStartedInteraction() {
		m_OnAlyxStartedInteraction.FireOutput( this, this );
	}
	virtual void AlyxFinishedInteraction() {
...
public:
	virtual const char* Name() { return "CPostFrameNavigationHook"; }

	virtual bool Init();
	virtual void FrameUpdatePostEntityThink();
	virtual void FrameUpdatePreEntityThink();

	bool IsGameFrameRunning() { return m_bGameFrameRunning; }
