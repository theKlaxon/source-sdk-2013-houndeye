...
public:
	...
	virtual bool UsesFilter() { return ( m_hFilter.Get() != NULL ); }
...
class CTriggerHurtShim : public CBaseTrigger {
	virtual void RadiationThink() = 0;
	virtual void HurtThink() = 0;

public:
	void RadiationThinkShim() { RadiationThink(); }
	void HurtThinkShim() { HurtThink(); }
};
