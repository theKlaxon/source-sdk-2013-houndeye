...
public:
	...
	Vector EyeDirection3D() { return CAI_BaseHumanoid::EyeDirection3D(); }// cops don't have eyes
...
private:
	...
	void OnAnimEventPreDeployManhack();
	...
	// Rappel
	virtual bool IsWaitingToRappel() { return m_RappelBehavior.IsWaitingToRappel(); }
