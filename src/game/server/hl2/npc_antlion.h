...
public:
	...
	virtual float InnateRange1MinRange() { return 50 * 12; }
	virtual float InnateRange1MaxRange() { return 250 * 12; }

	bool IsWorker() const { return HasSpawnFlags( SF_ANTLION_WORKER ); }// NOTE: IsAntlionWorker function must agree!
	...
	bool HandleInteraction( int interactionType, void* data, CBaseCombatCharacter* sender = nullptr );
	...
	virtual int GetSoundInterests() { return ( BaseClass::GetSoundInterests() ) | ( SOUND_DANGER | SOUND_PHYSICS_DANGER | SOUND_THUMPER | SOUND_BUGBAIT ); }
	virtual bool IsHeavyDamage( const CTakeDamageInfo& info );

	Class_T Classify() { return CLASS_ANTLION; }
	...
	bool ShouldAbandonFollow();

	void SetMoveState( AntlionMoveState_e state );
	int ChooseMoveSchedule();
	...
	const char* GetParentSpawnerName() { return STRING( m_strParentSpawner ); }

	virtual void StopLoopingSounds();
	bool AllowedToBePushed();
...
private:
	inline CBaseEntity* EntityToWatch();
	void UpdateHead();
...
#ifdef HL2_EPISODIC
	extern float AntlionWorkerBurstRadius();
#endif
