...
public:
	...
	int GetAmmoCount() { return m_iAmmoCount; }
	...
	// Controller
	CBaseCombatCharacter* GetController();
	...
	// SF Tests.
	inline bool IsControllable() { return ( m_spawnflags & SF_TANK_CANCONTROL ) != 0; }
	inline bool IsActive() { return ( m_spawnflags & SF_TANK_ACTIVE ) != 0; }
	inline bool IsNPCControllable() { return ( m_spawnflags & SF_TANK_NPC_CONTROLLABLE ) != 0; }
	inline bool IsNPCSetController() { return ( m_spawnflags & SF_TANK_NPC_SET_CONTROLLER ) != 0; }
...
protected:
	...
	virtual Vector WorldBarrelPosition();
	void UpdateMatrix();
	...
	inline bool IsPlayerManned() { return m_hController && m_hController->IsPlayer() && ( m_spawnflags & SF_TANK_PLAYER ); }
	inline bool IsNPCManned() { return m_hController && m_hController->MyNPCPointer() && ( m_spawnflags & SF_TANK_NPC ); }
...
private:
	...
	bool NPC_InRoute() { return m_bNPCInRoute; }
	bool NPC_InterruptController();
