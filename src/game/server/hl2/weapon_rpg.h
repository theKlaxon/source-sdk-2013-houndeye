...
#else
	Class_T Classify() { return CLASS_MISSILE; }
#endif
...
public:
	...
	void DisableGuiding();
#if defined( HL2_DLL )
	virtual Class_T Classify() { return CLASS_COMBINE; }
#endif
...
public:
	...
	Vector GetLaserPosition();
	void StartLaserEffects();
	void StopLaserEffects();
	void UpdateLaserEffects();
	...
	const Vector& GetNPCLaserPosition();
