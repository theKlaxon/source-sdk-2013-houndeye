...
public:
	...
	bool TauCannonHasBeenCutOff() { return m_bGunHasBeenCutOff; }
	...
	bool HeadlightIsOn() { return m_bHeadlightIsOn; }
	void HeadlightTurnOn() { m_bHeadlightIsOn = true; }
	void HeadlightTurnOff() { m_bHeadlightIsOn = false; }
