...
public:
	...
	virtual float InnateRange1MaxRange() { return sk_vortigaunt_zap_range.GetFloat() * 12; }
	virtual int OnTakeDamage_Alive( const CTakeDamageInfo& info );
	virtual bool FInViewCone( CBaseEntity* pEntity );
	virtual bool ShouldMoveAndShoot();

	// vorts have a very long head/neck swing, so debounce heavily
	virtual float GetHeadDebounce() { return 0.7; }// how much of previous head turn to use

	virtual void Use( CBaseEntity* pActivator, CBaseEntity* pCaller, USE_TYPE useType, float value );
	virtual void AlertSound();
	virtual Class_T Classify() { return IsGameEndAlly() ? CLASS_PLAYER_ALLY_VITAL : CLASS_VORTIGAUNT; }
	...
	virtual bool IsPlayerAlly() { return true; }
	...
	bool IsLeading() { return ( GetRunningBehavior() == &m_LeadBehavior && m_LeadBehavior.HasGoal() ); }
	...
	virtual bool IsReadinessCapable() { return true; }
	virtual float GetReadinessDecay() { return 30.0f; }
	virtual bool ShouldRegenerateHealth() { return m_bRegenerateHealth; }
...
private:
	...
	bool IsCarryingNPC() const { return m_bCarryingNPC; }
	bool m_bCarryingNPC;
