...
public:
	...
	int GetNumBreakableChunks() { return m_iNumBreakableChunks; }

	virtual bool OverridePropdata() { return false; }
	virtual IPhysicsObject* GetRootPhysicsObjectForBreak();

	bool PropDataOverrodeBlockLOS() { return m_bBlockLOSSetByPropData; }
	bool PropDataOverrodeAIWalkable() { return m_bIsWalkableSetByPropData; }
	...
	virtual QAngle PreferredCarryAngles() { return m_preferredCarryAngles; }
...
public:
	...
	float GetDmgModBullet() { return m_flDmgModBullet; }
	float GetDmgModClub() { return m_flDmgModClub; }
	float GetDmgModExplosive() { return m_flDmgModExplosive; }
	...
	float GetExplosiveRadius() { return m_explodeRadius; }
	float GetExplosiveDamage() { return m_explodeDamage; }
	void SetPhysicsDamageTable( string_t iszTableName ) { m_iszPhysicsDamageTableName = iszTableName; }
	string_t GetPhysicsDamageTable() { return m_iszPhysicsDamageTableName; }
	void SetBreakableModel( string_t iszModel ) { m_iszBreakableModel = iszModel; }
	string_t GetBreakableModel() { return m_iszBreakableModel; }
	void SetBreakableSkin( int iSkin ) { m_iBreakableSkin = iSkin; }
	int GetBreakableSkin() { return m_iBreakableSkin; }
	void SetBreakableCount( int iCount ) { m_iBreakableCount = iCount; }
	int GetBreakableCount() { return m_iBreakableCount; }
	void SetMaxBreakableSize( int iSize ) { m_iMaxBreakableSize = iSize; }
	int GetMaxBreakableSize() { return m_iMaxBreakableSize; }
	...
	string_t GetBasePropData() { return m_iszBasePropData; }
	...
	mp_break_t GetMultiplayerBreakMode() const { return m_mpBreakMode; }
...
public:
	...
	string_t GetPhysOverrideScript() { return m_iszOverrideScript; }
	float GetMassScale() { return m_massScale; }
