...
public:
	...
	ConceptInfo_t* GetConceptInfo( AIConcept_t _concept );
	void OnSpokeConcept( CAI_PlayerAlly* pPlayerAlly, AIConcept_t _concept, AI_Response* response );
	...
	bool ConceptDelayExpired( AIConcept_t _concept );
...
public:
	...
	int ObjectCaps() { return UsableNPCObjectCaps( BaseClass::ObjectCaps() ); }
	void TalkInit();
	...
	// Speech & Acting
	//---------------------------------
	CBaseEntity* EyeLookTarget();// Override to look at talk target
	...
	CAI_SpeechFilter* GetSpeechFilter() { return m_hSpeechFilter; }
	...
	virtual void PostSpeakDispatchResponse( AIConcept_t _concept, AI_Response* response );
	...
	bool SelectSpeechResponse( AIConcept_t _concept, const char* pszModifiers, CBaseEntity* pTarget, AISpeechSelection_t* pSelection );
	void SetPendingSpeech( AIConcept_t _concept, AI_Response& Response );
	...
	bool IsOkToSpeak();
	bool IsOkToCombatSpeak();
	bool IsOkToSpeakInResponseToPlayer();

	bool ShouldSpeakRandom( AIConcept_t _concept, int iChance );
	bool IsAllowedToSpeak( AIConcept_t _concept, bool bRespondingToPlayer = false );
	virtual bool SpeakIfAllowed( AIConcept_t _concept, const char* modifiers = NULL, bool bRespondingToPlayer = false, char* pszOutResponseChosen = NULL, size_t bufsize = 0 );
	...
	void OnSpokeConcept( AIConcept_t _concept, AI_Response* response );
	...
	virtual const char* GetDeathMessageText() { return "GAMEOVER_ALLY"; }
...
protected:
	...
	virtual bool ShouldRegenerateHealth() { return ( Classify() == CLASS_PLAYER_ALLY_VITAL ); }
#endif
	...
	// context.
	inline bool IsGameEndAlly() { return m_bGameEndAlly; }
