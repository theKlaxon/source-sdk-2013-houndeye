...
#define PANEL_ROUND_CORNER_ALL PANEL_ROUND_CORNER_TOP_LEFT | PANEL_ROUND_CORNER_TOP_RIGHT | PANEL_ROUND_CORNER_BOTTOM_LEFT | PANEL_ROUND_CORNER_BOTTOM_RIGHT
	...
	public:
		...
		const char* GetName();                // returns the name of this panel... never nullptr
		...
		virtual bool RequestFocusPrev( VPANEL panel = NULL_PANEL_HANDLE );
		virtual bool RequestFocusNext( VPANEL panel = NULL_PANEL_HANDLE );
		// tab positioning
	...
	*/
		...
		Panel* GetNavToRelay( Panel* first = nullptr );
		Panel* GetNavActivate( Panel* first = nullptr );
		Panel* GetNavBack( Panel* first = nullptr );

		const char* GetNavUpName() const { return m_sNavUpName.String(); }
		const char* GetNavDownName() const { return m_sNavDownName.String(); }
		const char* GetNavLeftName() const { return m_sNavLeftName.String(); }
		const char* GetNavRightName() const { return m_sNavRightName.String(); }
		const char* GetNavToRelayName() const { return m_sNavToRelayName.String(); }
		const char* GetNavActivateName() const { return m_sNavActivateName.String(); }
		const char* GetNavBackName() const { return m_sNavBackName.String(); }
