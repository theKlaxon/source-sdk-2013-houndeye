...
public:
	...
	// UNDONE: Sets are currently limited to 32 elements.  More elements will return nullptr in create.
...
public:
	...
	enum simresult_e { SIM_NOTHING = 0,
...
public:
	...
	virtual Vector GetInertia() const = 0;
	virtual Vector GetInvInertia() const = 0;
	...
	// NOTE: You can pass nullptr for either to avoid computations
...
public:
	...
	virtual IPhysicsObject* GetStartObject() = 0;

	// Get the end object
	virtual IPhysicsObject* GetEndObject() = 0;
};
...
#define DEFINE_PIID( type, enumval ) \
	template<>                       \
	inline PhysInterfaceId_t GetPhysIID<type>( type** ) { return enumval; }
