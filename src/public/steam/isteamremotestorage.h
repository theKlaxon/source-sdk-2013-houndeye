...
enum ERemoteStoragePlatform {
	...
	k_ERemoteStoragePlatformOSX [[deprecated]] = ( 1 << 1 ),
	k_ERemoteStoragePlatformPS3 [[deprecated]] = ( 1 << 2 ),
...
#if defined( VALVE_CALLBACK_PACK_SMALL )
	static_assert( sizeof( RemoteStorageEnumerateUserSubscribedFilesResult_t ) == ( 1 + 1 + 1 + 50 + 100 ) * 4 );
#elif defined( VALVE_CALLBACK_PACK_LARGE )
	static_assert( sizeof( RemoteStorageEnumerateUserSubscribedFilesResult_t ) == ( 1 + 1 + 1 + 50 + 100 ) * 4 + 4 );
#else
