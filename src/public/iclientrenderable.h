...
public:
	...
	// Rendering clip plane, should be 4 floats, return value of nullptr indicates a disabled render clip plane
	...
	virtual bool IgnoresZBuffer() const = 0;
};
...
public:
	...
	virtual bool IgnoresZBuffer() const { return false; }
