...
template<>
ALWAYS_INLINE QAngle Lerp<QAngle>( float flPercent, const QAngle& q1, const QAngle& q2 ) {
...
template<>
ALWAYS_INLINE QAngleByValue Lerp<QAngleByValue>( float flPercent, const QAngleByValue& q1, const QAngleByValue& q2 ) {
	// Avoid precision errors
	if ( q1 == q2 )
		return q1;
