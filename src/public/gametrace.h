...
public:
	...
	bool IsEmpty() const { return ( m_nLeafCount == 0 && m_nEntityCount == 0 ); }

	int LeafCount() const { return m_nLeafCount; }
	int LeafCountMax() const { return m_aLeafList.Count(); }
	void LeafCountReset() { m_nLeafCount = 0; }

	int EntityCount() const { return m_nEntityCount; }
	int EntityCountMax() const { return m_aEntityList.Count(); }
	void EntityCountReset() { m_nEntityCount = 0; }
