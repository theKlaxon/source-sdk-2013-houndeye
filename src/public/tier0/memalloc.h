...
#include "tier0/mem.h"
	...
	inline void* MemAlloc_AllocAligned( size_t size, size_t align, const char* pszFile = nullptr, int nLine = 0 ) { return memalign( align, size ); }
...
// linux memory tracking via hooks.
	...
	PLATFORM_INTERFACE void DumpMemorySummary();
