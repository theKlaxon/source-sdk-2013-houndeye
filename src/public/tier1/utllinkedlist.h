...
protected:
	...
	ALWAYS_INLINE M const& Memory( void ) const {
		return m_Memory;
	}
...
CUtlLinkedList<T, S, ML, I, M>::CUtlLinkedList( int growSize, int initSize ) : m_Memory( growSize, initSize ), m_LastAlloc( m_Memory.InvalidIterator() ) {
