...
template<int nFlags, int nNumTexCoords>
ALWAYS_INLINE void CVertexBuilder::AdvanceVertexF() {
...
//-----------------------------------------------------------------------------
template<int nFlags, int nNumTexCoords>
ALWAYS_INLINE void CMeshBuilder::AdvanceVertexF() {
...
template<VertexCompressionType_t T>
ALWAYS_INLINE void CMeshBuilder::CompressedBoneWeight3fv( const float* pWeights ) {
...
template<VertexCompressionType_t T>
ALWAYS_INLINE void CMeshBuilder::CompressedUserData( const float* pData ) {
...
template<VertexCompressionType_t T>
ALWAYS_INLINE void CMeshBuilder::CompressedNormal3f( float nx, float ny, float nz ) {
	m_VertexBuilder.CompressedNormal3f<T>( nx, ny, nz );
}

template<VertexCompressionType_t T>
ALWAYS_INLINE void CMeshBuilder::CompressedNormal3fv( const float* n ) {
