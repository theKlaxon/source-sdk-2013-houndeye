...
enum MaterialPrimitiveType_t {
	...
	MATERIAL_QUADS,
	MATERIAL_INSTANCED_QUADS,// (X 360 og) like MATERIAL_QUADS, but uses vertex instancing
...
struct FlashlightState_t {
	...
	[[nodiscard]] int GetLeft() const { return m_nLeft; }
	[[nodiscard]] int GetTop() const { return m_nTop; }
	[[nodiscard]] int GetRight() const { return m_nRight; }
	[[nodiscard]] int GetBottom() const { return m_nBottom; }
...
public:
	...
	[[nodiscard]] virtual int GetRefCount() const = 0;
};
...
typedef void ( *ModeChangeCallbackFunc_t )();
