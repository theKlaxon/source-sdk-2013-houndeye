...
public:
	...
	virtual IPhysicsObject* GetReferenceObject() const = 0;

	// Get the attached object
	virtual IPhysicsObject* GetAttachedObject() const = 0;
...
public:
	virtual ~IPhysicsConstraintGroup() {}
	virtual void Activate() = 0;
