...
abstract_class CDefSaveRestoreBlockHandler : public ISaveRestoreBlockHandler {
	const char* GetBlockName() override = 0;
	...
	void Restore( IRestore*, bool fCreatePlayers ) override {}
...
public:
	...
	virtual bool GetPrecacheMode() = 0;
...
public:
	...
	void Save( void* pField, ISave* pSave ) {
		SaveRestoreFieldInfo_t fieldInfo = { pField, nullptr, nullptr };
...
public:
	...
	bool IsEmpty( const SaveRestoreFieldInfo_t& fieldInfo ) override  { return false; }
	void MakeEmpty( const SaveRestoreFieldInfo_t& fieldInfo ) override  {}
	bool Parse( const SaveRestoreFieldInfo_t& fieldInfo, char const* szValue ) override  { return false; }
};
