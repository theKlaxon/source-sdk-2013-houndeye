...
#define DEFINE_CUSTOM_FIELD( name, datafuncs ) \
	{ FIELD_CUSTOM, #name, { static_cast<int>( offsetof( classNameTypedef, name ) ), 0 }, 1, FTYPEDESC_SAVE, NULL, datafuncs, NULL }
...
#define DEFINE_INPUT( name, fieldtype, inputname ) \
	{ fieldtype, #name, { static_cast<int>( offsetof( classNameTypedef, name ) ), 0 }, 1, FTYPEDESC_INPUT | FTYPEDESC_SAVE | FTYPEDESC_KEY, inputname, NULL, NULL, NULL, sizeof( ( (classNameTypedef*) 0 )->name ) }
#define DEFINE_INPUTFUNC( fieldtype, inputname, inputfunc ) \
	{ fieldtype, #inputfunc, { 0, 0 }, 1, FTYPEDESC_INPUT, inputname, nullptr, static_cast<inputfunc_t>( &classNameTypedef::inputfunc ) }
...
#define DEFINE_OUTPUT( name, outputname ) \
	{ FIELD_CUSTOM, #name, { static_cast<int>( offsetof( classNameTypedef, name ) ), 0 }, 1, FTYPEDESC_OUTPUT | FTYPEDESC_SAVE | FTYPEDESC_KEY, outputname, eventFuncs }

// replaces EXPORT table for portability and non-DLL based systems (xbox)
#define DEFINE_FUNCTION_RAW( function, func_type ) \
	{ FIELD_VOID, nameHolder.GenerateName( #function ), { 0, 0 }, 1, FTYPEDESC_FUNCTIONTABLE, nullptr, nullptr, (inputfunc_t) ( (func_type) ( &classNameTypedef::function ) ) }
